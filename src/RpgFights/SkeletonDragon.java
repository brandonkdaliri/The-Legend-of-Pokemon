...
public class SkeletonDragon extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setText("[BOSS] Skeleton Dragon");
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/rpgfights/Sprites/SkeletonDragon.gif"))); // NOI18N

        jLabel3.setIcon(new javax.swing.ImageIcon(getClass().getResource("/rpgfights/Sprites/link.gif"))); // NOI18N
    ...
    private void AttackButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AttackButtonActionPerformed
        ...
        if (currentPlayerHP <= 0) {
            combatText = "YOU WIN! You scavange 100 gold from the bones of the dead dragon!";
            gold += 100;
        ...
        if (turn == false) {
            ...
            if (accuracy > 25) {
                ...
                if (oppability < 7) {
                    ...
                    EndButton.setEnabled(false);
                    if (oppATKMod < 3) {
                        combatText = combatText + " \nThe mighty dragon roars dealing " + opptotDMG + " damage and raising their attack";
                        jTextArea2.setText(combatText);
                        oppATKMod += 1;
                    } else {
                        combatText = combatText + " \nThe mighty dragon roars dealing " + opptotDMG + " damage!";
                        jTextArea2.setText(combatText);
                    }
        ...
        if (turn == true) {
            if (playerMana > 15) {
                if (oppATKMod > -2) {
                    ...
                    attackBuff.setEnabled(false);
                    attackDebuff.setEnabled(false);
                    combatText = combatText + " \nYou lowered their attack";
                    jTextArea2.setText(combatText);
                    Ability.setEnabled(false);

                } else {
                    combatText = combatText + " \nEnemies attack won't go any lower!";
                    jTextArea2.setText(combatText);
                }
            } else {
                combatText = combatText + " \nNot enough mana!";
    ...
    private void healthPotionsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_healthPotionsActionPerformed
        if (turn == true && hpPotions > 0 && currentPlayerHP < playerHP - 25) {
            currentPlayerHP += 30;
            ShowPlayerHealth.setValue(currentPlayerHP);
    ...
    private void ManaPotionUse(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ManaPotionUse
        if (turn == true && manaPotions > 0 && currentPlayerHP < playerHP - 25) {
