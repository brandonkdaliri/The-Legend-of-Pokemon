 ...
 * @author 068685601
 */
public class SkeletonDragon extends javax.swing.JFrame {
    ...
    public SkeletonDragon() {
        this.playerDMG = rand.nextInt((playerATK + playerATKMod));
        t1.start();
        initComponents();
        getContentPane().setBackground(new Color(102, 51, 0));
        song = rand.nextInt(5);
        if (song == 0) {
            Sound.play("Boss1.1.wav");
        } else if (song == 1) {
            Sound.play("Boss2.1.wav");
        } else if (song == 2) {
            Sound.play("Boss3.1.wav");
        } else if (song == 3) {
            Sound.play("Boss4.1.wav");
        } else if (song == 4) {
            Sound.play("Boss5.1.wav");
        }
    }
    ...
    private void initComponents() {
        ...
        ShowPlayerHealth.setMaximum(playerHP);
        ...
        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Battle/boss.gif"))); // NOI18N
...
private class TimerListener implements ActionListener {
    ...
    private void AttackButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AttackButtonActionPerformed
        ...
        if (currentoppHP <= 0) {
            goldfound = rand.nextInt(50) + 40;
            combatText = "\nYOU WIN! \nYou scavanged" + goldfound + "gold from the bones of the dragon!";
            jTextArea2.setText(combatText);
            gold += 20;
            attackBuff.setEnabled(false);
            attackDebuff.setEnabled(false);
        ...
        if (currentoppHP < oppHP / 2 && currentPlayerHP > playerHP / 4) {
    ...
    private void EndButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_EndButtonActionPerformed
        ...
        if (turn == false) {
            ...
            if (accuracy > 25) {
                ...
                if (oppability < 9) {
                    ...
                    turn = true;
                    EndButton.setEnabled(true);
                    combatText = combatText + " \nThe dragon fires a fireball dealing " + opptotDMG + " damage!";
                    jTextArea2.setText(combatText);
                    ...
                    EndButton.setEnabled(true);
                    if (playerATKMod > -4) {
                        combatText = combatText + " \nThe dragon roars a might roar dealing " + opptotDMG + " damage\nand raises his attack!";
                        jTextArea2.setText(combatText);
                        playerATKMod -= 1;
                        Sound.play("PlayerHit.wav");
                    } else {
                        combatText = combatText + " \nThe dragon roars dealing " + opptotDMG + " damage!";
                        jTextArea2.setText(combatText);
                        Sound.play("PlayerHit.wav");
                    }
                ...
                combatText = combatText + " \nThe dragon charges forward but you jump out of the way!";
                jTextArea2.setText(combatText);
                EndButton.setEnabled(true);
                turn = true;
                Sound.play("Miss.wav");
        ...
        if (currentPlayerHP < playerHP / 2 && currentPlayerHP > playerHP / 4) {
            ShowPlayerHealth.setForeground(Color.YELLOW);
        } else if (currentPlayerHP < playerHP / 4) {
    ...
    private void healthPotionsActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_healthPotionsActionPerformed
        if (turn == true && hpPotions > 0 && currentPlayerHP < playerHP - 30) {
            currentPlayerHP += 30;
            ShowPlayerHealth.setValue(currentPlayerHP);
    ...
    private void ManaPotionUse(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ManaPotionUse
        if (turn == true && manaPotions > 0 && currentPlayerHP < playerMana - 20) {
